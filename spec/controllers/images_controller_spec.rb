...
describe ImagesController do
  ...
  let(:valid_attributes) { { "image_name" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved image as @image" do
        ...
        post :create, {:image => { "image_name" => "invalid value" }}, valid_session
        assigns(:image).should be_a_new(Image)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested image" do
        ...
        Image.any_instance.should_receive(:update).with({ "image_name" => "MyString" })
        put :update, {:id => image.to_param, :image => { "image_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the image as @image" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Image.any_instance.stub(:save).and_return(false)
        put :update, {:id => image.to_param, :image => { "image_name" => "invalid value" }}, valid_session
        assigns(:image).should eq(image)
      end
