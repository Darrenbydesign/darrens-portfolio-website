class StaticPagesController < ApplicationController
  ...
  def portfolio
    ...
    [
      ...
      'Black Epiphany is an organization based in New Orleans, Louisiana. It is a movement created to help African Americans in lower income neighborhoods overcome and reach beyond the struggles they face in their communities. It’s member base is made up of young adults. The founder of this organization asked me to design a logo to visualize his idea. I worked with his concept and created the design displayed here. The design features a globe overlapped by a fist which is holding a broken chain. The chain is a symbol meant to represent breaking stereotypes that are typically assumed in these communities. The founder of the Black Epiphany was very pleased with this design and the way it represents the organization.',
      'Empire Fence Co, is a fencing company based in Tulsa, Oklahoma. I decided to use the company as a branding and identity experiment after I discovered their existing logo and company design. The goal of the design was to create a new look for the company that would make them appear more modern while also better representing their company name. The redesign of the logo features a crown with a chain–linked fence  pattern which effectively represents the brand in the icon alone, but it’s also coupled with a classic typeface to emphasize the mood of the brand.',
      'PIAT is a codename for the application a co-worker and I were developing together. The project was created for an interface that would allow members of the load integration team to handle their day to day tasks from one convenient location.
